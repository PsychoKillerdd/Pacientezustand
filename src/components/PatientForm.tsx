          ...
          >
                <div className="mb-5">
                    ...
                    <input  
                        ...
                        {...register('name', {required:'El nombre de este paciente es requerido',
                            maxLength: {
                                value: 8,
                ...
                <div className="mb-5">
                  ...
                  <input  
                      ...
                      {...register('caretaker', {required:'El Propietario de este paciente es requerido',
                        maxLength: {
                            value: 8,
                            message: 'El Propietario no puede tener más de 8 caracteres'
                        }
                    })}
                  />
                  {errors.caretaker &&(<Error>
